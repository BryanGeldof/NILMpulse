...
class PeakSenseClusterAnalyzer:
    def __init__(self, hass):
        ...
        self.boost_active = False  # Wordt TRUE via de nieuwe Boost-service
    ...
    def process_reading(self, current_total):
        ...
        # Dynamische baseload bijstelling
        ...
        # 4. Analyseer onbekende flanken (Positief en Negatief vanaf 5 Watt)
    ...
    def _trigger_hass_notification(self, cluster_id, wattage):
        ...
        notify_device = config_entry.data.get("notification_device")
        
        # Haal de slimme suggestie op uit de matrix
        suggestion = self._get_suggestion(wattage)

        if notify_device:
            # Volledige Actionable Pushnotificatie voor V0.3.0/V0.2.0 gsm test
                ...
                self.hass.services.async_call(
                    ...
                    notify_device.split(".")[1],
                    {
                        ...
                        "data": {
                            "actions": [
                                {
                                    "action": f"NILMPULSE_LABEL_{cluster_id}",
                                    "title": "Geef naam",
                                    "behavior": "text_input",
            ...
            # Universele Home Assistant UI Notificatie met de slimme suggestie ingebouwd!
